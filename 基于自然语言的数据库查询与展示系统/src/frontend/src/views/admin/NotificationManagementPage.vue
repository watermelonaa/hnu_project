<!--
  @file views/admin/NotificationManagementPage.vue
  @description 通知管理页面（系统管理员）
...
<template>
  <div class="flex-1 overflow-y-auto p-6 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
      <div class="overflow-x-auto">
        <table class="w-full text-sm">
          <thead>
            <tr class="bg-gray-50">
              <th class="px-6 py-3 text-left min-w-32">标题</th>
              <th class="px-6 py-3 text-left min-w-24">目标角色</th>
              <th class="px-6 py-3 text-left min-w-20">优先级</th>
              <th class="px-6 py-3 text-left min-w-24">发布者</th>
              <th class="px-6 py-3 text-left min-w-40">发布时间</th>
              <th class="px-6 py-3 text-left min-w-20">状态</th>
              <th class="px-6 py-3 text-left min-w-32">操作</th>
            </tr>
          </thead>
          <tbody>
            <tr
    ...
    <!-- 查看详情模态框 -->
    <AdminModal :is-open="modal === 'view'" title="通知详情" @close="closeModal">
    ...
    <!-- 删除确认模态框 -->
    <AdminModal :is-open="modal === 'delete'" title="确认删除通知" @close="closeModal">
...
const loadNotifications = async () => {
  try {
    ...
    const adminNotifications = notificationList.map((n) => ({
      ...
      pinned: n.isTop === 1,
      publisher: '系统管理员', // 需要从API获取或从用户信息获取
